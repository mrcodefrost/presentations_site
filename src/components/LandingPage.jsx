                ...
                {["We Create", "Eye opening", "Presentations"].map((item, index) => {
                    return <div key={index} className="masker">
                        <div className="w-fit flex">
                            {index === 1 && (<div className="w-[5.5vw] h-[4vw] relative  bg-red-50 leading-[1vw]"> </div>)}
                            <h1 className="uppercase text-[5.5vw] leading-[6vw] tracking-tighter font-['Founders_Grotesk'] font-medium">
                                {item}
                            </h1>
                        </div>
                    </div>
